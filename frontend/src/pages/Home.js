...
const Home = () => {
  ...
  return (
    <div className="main-content">
      ...
      {/* Night Experiences Section */}
      <section className="section section-alt" data-testid="night-experiences-section">
        <div className="container">
          <div className="section-header">
            <h2 className="section-title" data-testid="night-experiences-title">
              Magical Night Float Experiences
            </h2>
            <p className="section-subtitle" data-testid="night-experiences-subtitle">
              Transform your evening into an unforgettable adventure with our LED-equipped watercraft
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="card text-center" data-testid="night-kayaks-card">
              <CardHeader>
                <div className="mx-auto mb-4 w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center">
                  <span className="text-3xl">🛶</span>
                </div>
                <CardTitle className="text-purple-700">Night Kayaking</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Glide through glowing waters in our LED-equipped crystal kayaks. 
                  Watch your transparent vessel illuminate the emerald Gulf beneath you.
                </p>
                <div className="text-sm text-purple-600 font-semibold">Available Nightly</div>
              </CardContent>
            </Card>

            <Card className="card text-center" data-testid="night-canoes-card">
              <CardHeader>
                <div className="mx-auto mb-4 w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center">
                  <span className="text-3xl">🚣</span>
                </div>
                <CardTitle className="text-purple-700">Night Canoeing</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Perfect for couples and families - our LED-lit crystal canoes create 
                  romantic floating paths under the starlit Panama City sky.
                </p>
                <div className="text-sm text-purple-600 font-semibold">Available Nightly</div>
              </CardContent>
            </Card>

            <Card className="card text-center" data-testid="night-paddleboards-card">
              <CardHeader>
                <div className="mx-auto mb-4 w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center">
                  <span className="text-3xl">🏄</span>
                </div>
                <CardTitle className="text-purple-700">Night Paddle Boarding</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Stand atop our LED-illuminated crystal paddle boards and create 
                  magical light trails as you explore the Gulf after sunset.
                </p>
                <div className="text-sm text-purple-600 font-semibold">Available Nightly</div>
              </CardContent>
            </Card>
          ...
          <div className="text-center mt-8">
            <Link to="/bookings">
              <Button 
                ...
                data-testid="night-experiences-book-btn"
              >
